...
Neither service terminates TLS. Put a reverse proxy (nginx, Caddy, a cloud
LB) in front of each and terminate there. The bearer tokens are only as safe
as the transport — sending them in cleartext over the public internet defeats
